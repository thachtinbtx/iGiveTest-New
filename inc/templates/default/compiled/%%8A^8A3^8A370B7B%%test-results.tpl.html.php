<?php /* Smarty version 2.6.18, created on 2025-12-02 13:08:28
      ...
      <?php else: ?>
        ...
        <div class="text-center mb-8">
          <h1 class="text-3xl sm:text-5xl font-extrabold text-accent mb-2 tracking-tight drop-shadow-sm">
            <?php echo $this->_tpl_vars['g_vars']['page']['header']; ?>

          </h1>
          <p class="text-muted text-base sm:text-lg font-medium">
            <?php echo $this->_tpl_vars['g_vars']['page']['test_name_label']; ?>
        ...
        <div class="flex justify-center mb-10">
          <div class="relative">
            ...
            <div class="neu-card rounded-full w-48 h-48 sm:w-64 sm:h-64 flex flex-col items-center justify-center ring-4 ring-white/10">
              <div class="text-muted text-xs sm:text-sm font-bold uppercase tracking-wider mb-1 sm:mb-2">Điểm số</div>
              <div class="text-5xl sm:text-7xl font-black text-accent drop-shadow-md">
                <?php if ($_SESSION['MAIN']['yt_result_showpoints']): ?>
                  <?php echo $this->_tpl_vars['g_vars']['page']['score']; ?>
%
                <?php else: ?>
                  --
                <?php endif; ?>
              ...
              <?php if ($_SESSION['MAIN']['yt_result_showpoints']): ?>
                <div class="text-muted text-xs mt-2 font-medium px-4 text-center">
                  <span class="block text-sm font-bold"><?php echo $_SESSION['MAIN']['yt_got_points']; ?>
 / <?php echo $_SESSION['MAIN']['yt_pointsmax']; ?>
</span>
                  <?php if ($_SESSION['MAIN']['yt_points_pending'] > 0): ?>
                    <span class="block text-[10px] text-red-400 mt-1 font-bold">(Chưa tính điểm trả lời tự luận)</span>
                  <?php else: ?>
                    <span class="text-[10px] uppercase tracking-wide">Điểm đạt được / Tổng điểm bài thi</span>
                  <?php endif; ?>
                </div>
              <?php endif; ?>
            </div>
            ...
            <?php if ($this->_tpl_vars['g_vars']['page']['score'] == 100): ?>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-10">
          ...
          <div class="neu-card rounded-2xl p-4 sm:p-5 group">
            <div class="flex items-center gap-3">
              ...
              <div class="flex-1">
                <div class="text-muted text-xs font-bold uppercase tracking-wide">Ngày thi</div>
                <div class="text-main font-bold text-sm sm:text-base"><?php echo $this->_tpl_vars['g_vars']['page']['test_date']; ?>
</div>
              </div>
            </div>
          </div>
          ...
          <div class="neu-card rounded-2xl p-4 sm:p-5 group">
            <div class="flex items-center gap-3">
              ...
              <div class="flex-1">
                <div class="text-muted text-xs font-bold uppercase tracking-wide">Thời gian</div>
                <div class="text-main font-bold text-sm sm:text-base"><?php echo $this->_tpl_vars['g_vars']['page']['time_spent']; ?>
</div>
              </div>
            </div>
          </div>
          ...
          <div class="neu-card rounded-2xl p-4 sm:p-5 group">
            <div class="flex items-center gap-3">
              ...
              <div class="flex-1">
                <div class="text-muted text-xs font-bold uppercase tracking-wide">Thời gian rời màn hình</div>
                <div class="text-rose-600 font-bold text-sm sm:text-base"><?php echo $this->_tpl_vars['g_vars']['page']['time_away']; ?>
</div>
              </div>
            </div>
          </div>
          ...
          <?php if ($_SESSION['MAIN']['yt_result_showanswers']): ?>
          <div class="neu-card rounded-2xl p-4 sm:p-5 group">
            <div class="flex items-center gap-3">
              <div class="bg-white/20 rounded-xl p-3 transition-colors">
              ...
              <div class="flex-1">
                <div class="text-muted text-xs font-bold uppercase tracking-wide">Số câu đúng</div>
                <div class="text-main font-bold text-sm sm:text-base">
                  <?php echo $_SESSION['MAIN']['yt_got_answers']; ?>
 / <?php echo $_SESSION['MAIN']['yt_questioncount']; ?>
          ...
          <!-- Grade Card -->
          <?php if ($_SESSION['MAIN']['yt_result_showgrade']): ?>
          <div class="neu-card rounded-2xl p-4 sm:p-5 sm:col-span-2 lg:col-span-3 group">
            <div class="flex items-center justify-center gap-4">
              ...
              <div class="text-center">
                <div class="text-muted text-xs font-bold uppercase tracking-wide">Xếp loại</div>
                <div class="text-accent font-black text-3xl sm:text-4xl drop-shadow-sm"><?php echo $this->_tpl_vars['g_vars']['page']['grade']['name']; ?>
</div>
              </div>
            </div>
          </div>
        ...
        <!-- Grade Feedback -->
        <?php if ($_SESSION['MAIN']['yt_result_showgradefeedback']): ?>
          <div class="neu-card rounded-2xl p-5 sm:p-6 mb-8 border-l-4 border-accent">
            <div class="flex items-start gap-3">
              ...
              <div>
                ...
                <p class="text-muted leading-relaxed"><?php echo $this->_tpl_vars['g_vars']['page']['grade']['feedback']; ?>
</p>
              </div>
            </div>
          </div>
        ...
        <!-- Download Options -->
        <?php if ($this->_tpl_vars['g_vars']['page']['show_advancedreport_html'] || $this->_tpl_vars['g_vars']['page']['show_advancedreport_pdf']): ?>
        <div class="flex flex-wrap justify-center gap-3 mb-8">
          <?php if ($this->_tpl_vars['g_vars']['page']['show_advancedreport_html']): ?>
            <a href="getfile.php?action=thtml&resultid=<?php echo $_SESSION['MAIN']['resultid']; ?>
" target="_blank" 
          ...
          <?php endif; ?>
          <?php if ($this->_tpl_vars['g_vars']['page']['show_advancedreport_pdf']): ?>
            <a href="getfile.php?action=tpdf&resultid=<?php echo $_SESSION['MAIN']['resultid']; ?>
&file=test-results.pdf" target="_blank"
               class="neu-card px-5 py-3 rounded-xl flex items-center gap-2 text-muted font-bold text-sm sm:text-base active:scale-95">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div class="flex flex-col sm:flex-row justify-center gap-4 mt-8">
        <?php if ($this->_tpl_vars['g_vars']['page']['show_reportsmanager']): ?>
          <a href="reports-manager.php?action=viewq&resultid=<?php echo $_SESSION['MAIN']['resultid']; ?>
" 
        ...
        <?php if ($this->_tpl_vars['g_vars']['page']['show_nexttest']): ?>
          <a href="test.php?testid=<?php echo $_SESSION['MAIN']['yt_nexttestid']; ?>
" 
             class="neu-btn w-full sm:w-auto px-8 py-3.5 text-base font-bold text-center rounded-xl hover:scale-105 transition-transform">
        ...
        <?php else: ?>
          <a href="index.php" 
            ...
            <?php echo $this->_tpl_vars['lngstr']['page_test_results_homepage']; ?>
      ...
      <div class="text-center mt-10 text-muted text-sm font-medium italic opacity-80">
        Chúc các em ngày càng học tốt hơn! 🎓
      </div>

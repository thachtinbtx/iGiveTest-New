<?php /* Smarty version 2.6.18, created on 2025-12-03 15:17:39
...
<link rel="stylesheet" href="inc/css/design-system.css">
...
" class="flex flex-col items-center justify-center gap-1 text-slate-600 hover:text-indigo-600">
    ...
    <div id="mobile-more-drawer" class="fixed bottom-0 left-0 right-0 z-40 bg-white/70 backdrop-blur-xl rounded-t-3xl p-4 pb-24 transform translate-y-full transition-transform duration-300 ease-in-out md:hidden">
        ...
        <nav class="flex flex-col gap-2">
            ...
            <a href="signout.php" class="font-semibold text-red-500 p-3 rounded-lg hover:bg-white/50 flex items-center gap-2">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"></path></svg>
                <?php echo $this->_tpl_vars['lngstr']['panel_signout']; ?>

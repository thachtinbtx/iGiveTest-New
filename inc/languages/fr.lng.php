...
$lngstr['branding']['btm_sign'] = 'Copyright &copy; 2004-2007. Tous droits réservés.<br><a href="#" target=_blank>Legal Notices</a> | <a href="#" target=_blank>Privacy Policy</a> | <a href="#" target=_blank>Contact Us</a>';
// Sign in page:
$lngstr['page_signin_box_intro'] = '';

// Non-customizable (it is not recommended to customize this data):
// ----------------------------------------------------------------
$lngstr['branding']['powered_by'] = 'Turbinant à l\'aide de iGiveTest v'.IGT_VERSION.'';
// General:

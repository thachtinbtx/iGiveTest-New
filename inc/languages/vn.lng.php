...
// ----------------------------------------------------------------------
// Branding:
$lngstr['branding']['top_logo'] = '<img src="images/logo.png" width=100 height=100>';
$lngstr['branding']['btm_sign'] = '<a target="_blank" href="/"><b>Trang Chủ</b></a> 
<font color="green" ><b><br>    Trần Thạch - Thachtinbtx@gmail.com      </b></font>';
// Sign in page:
$lngstr['page_signin_box_intro'] = '';

// Non-customizable (it is not recommended to customize this data):
// ----------------------------------------------------------------
$lngstr['branding']['powered_by'] = 'Trần Thạch ';
// General:
$lngstr['meta_charset'] = 'utf8mb4';
$lngstr['sql_charset'] = 'utf8mb4';
...
$lngstr['label_atype_multiple_answer'] = 'Nhiều trả lời';
$lngstr['label_atype_truefalse'] = 'Đúng/Sai nhiều trả lời';
$lngstr['label_atype_truefalse_true'] = 'Đúng';
$lngstr['label_atype_truefalse_false'] = 'Sai';
$lngstr['label_atype_fillintheblank'] = 'Trả lời ĐS 4 đáp án';
$lngstr['label_atype_essay'] = 'Tự luận';
$lngstr['label_atype_random'] = 'Câu hỏi ngẫu nhiên';
$lngstr['label_atype_truefalse_multi'] = 'Đúng/Sai nhiều phát biểu';
$lngstr['label_statement'] = 'Phát biểu';
...
$lngstr['page_header_results'] = $lngstr['page_title_results'];
 ...
 $lngstr['page_reportsmanager']['your_answer'] = 'Câu trả lời của học sinh :';
...
$lngstr['page_title_edittests'] = 'Quản lý bài kiểm tra';
...
$lngstr['page_header_manageusers'] = $lngstr['page_title_manageusers'];
 ...
 $lngstr['page_title_users_memberof_users'] = '';
 $lngstr['page_title_users_memberof_groups'] = 'Nhóm';
 $lngstr['page_title_users_settings'] = '';
...
$lngstr['page_title_grades'] = 'Hệ thống sấp xếp';
...
$lngstr['panel_usersandgroups'] = 'Quản lý';
...
$lngstr['label_action_results_delete'] = 'Xóa Bản ghi này ';
...
$lngstr['label_action_tests_delete'] = 'Xóa Kiểm tra này ';
...
$lngstr['label_action_questions_append'] = 'Thêm câu hỏi này vào bài kiểm';
$lngstr['label_action_question_delete'] = 'Xóa Câu hỏi này';
$lngstr['label_action_questions_delete'] = 'Xóa Câu hỏi';
$lngstr['label_action_question_link_delete'] = 'Loại câu hỏi này ra khỏi bài kiểm';
$lngstr['label_action_question_links_delete'] = 'Loại câu hỏi này ra khỏi bài kiểm';
$lngstr['label_action_question_stats'] = 'Thống kê';
$lngstr['label_action_questions_stats'] = 'Thống kê';
$lngstr['label_action_manageusers_edit'] = 'Thiết đặt Người sử dụng';
$lngstr['label_action_manageusers_groups'] = 'Những nhóm người dùng';
$lngstr['label_action_groups'] = 'User groups)';
$lngstr['label_action_manageusers_delete'] = 'Xóa người sử dụng này';
$lngstr['label_action_users_delete'] = 'Xóa những người sử dụng';
$lngstr['label_action_create_user'] = 'Tạo ra một người sử dụng mới';
$lngstr['label_action_group_delete'] = 'Xóa nhóm này';
$lngstr['label_action_groups_delete'] = 'Xóa những nhóm ';
...
$lngstr['label_action_subjects_delete'] = 'Xóa những đề tài ';
...
$lngstr['label_action_etemplates_delete'] = 'Xoá mẫu Email này ';
...
$lngstr['label_action_grades_delete'] = 'Xoá hệ thống đường dốc ';
$lngstr['label_action_gradescales_edit'] = 'Soạn thảo quy mô đường dốc này';
$lngstr['label_action_gradescales_delete'] = 'Xóa Sắp xếp ';
...
$lngstr['label_action_visitors_delete'] = 'Xoá bản ghi ';
...
$lngstr['page-sections']['action_sections_delete'] = 'Xóa những mục(khu vực) ';
...
$lngstr['page-rtemplates']['action_rtemplates_delete'] = 'Xóa những khung mẫu báo cáo ';
...
$lngstr['label_result_got_points'] = '<b>Số câu đúng trên tổng số câu hỏi:  <font color="red"> %d / %d  </font>       ---      Điểm đạt được là : </b>   <font color="red"><b> %d /100  ( Thang điểm 100 )</b></font> <br><br><H3> <font color="blue">Chúc các em ngày càng học tốt hơn      :-)) ';
$lngstr['label_result_points_pending'] = '<b>Những điểm đang xem xét:</b> %d';
$lngstr['label_result_got_grade'] = '<b>Xếp loại:</b> %s';
$lngstr['label_result_got_gradefeedback'] = '<b>------------------------------------------------</b> %s';
$lngstr['label_result_do_not_show'] = 'Bài kiểm của học sinh đã được chấm điểm và ghi.';
...
$lngstr['label_report_hdr_result_timeexceeded'] = 'Quá thời gian';
$lngstr['label_report_hdr_result_timeexceeded_hint'] = 'Quá thời gian (Bấm để sắp xếp)';
$lngstr['label_report_hdr_result_points'] = 'Điểm đạt được';
$lngstr['label_report_hdr_result_points_hint'] = 'Điểm đạt được (Bấm để sắp xếp)';
$lngstr['label_report_hdr_result_pointsmax'] = 'Tổng điểm';
$lngstr['label_report_hdr_result_pointsmax_hint'] = 'Tổng điểm (Bấm để sắp xếp)';
$lngstr['label_report_hdr_result_score'] = 'Kết quả điểm ';
...
$lngstr['label_report_hdr2_result_answer_points'] = 'Điểm';
...
$lngstr['button_answer'] = 'Hoàn thành bài kiểm tra và gởi bài ';
...
$lngstr['label_firstname'] = 'Họ và Tên đệm :';
...
$lngstr['label_newpassword'] = 'Password mới:';
...
$lngstr['page_register']['no_username'] = '<br>';
...
$lngstr['page_register']['no_firstname'] = 'Chưa điền "Họ và Tên Điệm" ...<br>';
$lngstr['page_register']['no_lastname'] = 'Chưa điền "Tên" ...<br>';
...
$lngstr['page_register']['no_department'] = 'Đăng kí thiếu thông tin.<br>';
...
$lngstr['page_register']['no_userfield'] = 'Chưa điền "Lớp" ...<br>';
...
$lngstr['err_username_duplicate'] = '"Username" này đã được đăng kí, Hãy thử đăng nhập hoặc yêu cầu Admin kích hoạt tài khoản này ...<br>';
...
$lngstr['err_signin_incorrect']  = 'Không thể đăng nhập...    Username đã sai hoặc yêu cầu Admin kích hoạt tài khoản này!<br>';

// Register page:
$lngstr['page-register']['intro'] = 'em có thể sử dụng mẫu (dạng) này để thêm một tài khoản.';
$lngstr['page-register']['successful'] = 'Chào "%s" ! Thành công. <br>Chúc em học tốt !!! <br><br> <font color=blue>Admin: Trần Thạch, Email: thachtinbtx@gmail.Com</font>';
$lngstr['page-register']['check_activation_email'] = 'Một email đã được gửi tới địa chỉ (của) các em. Nó chứa đựng những chỉ dẫn để hoàn thành sự đăng ký (của) các em.';
$lngstr['page-register']['wait_for_approval'] = 'Tài khoản (của) Các em được tạo ra một cách thành công thì phải (thì)kích hoạt bởi một người quản trị, mời kiên nhẫn.';
$lngstr['page-register']['account_activated'] = 'Tài khoản (của) Các em đã được kích hoạt một cách thành công.';
$lngstr['page-register']['title_items'] = array('' => $lngstr['label_none'], 'Dr.' => 'Dr.', 'Miss' => 'Miss', 'Mr.' => 'Mr.', 'Mrs.' => 'Mrs.', 'Ms.' => 'Ms.', 'Prof.' => 'Prof.', 'Rev.' => 'Rev.');
$lngstr['page_register']['required_mark'] = REQUIRED_FIELD_MARK.' Tức là em phải bắt buộc nhập';

// Sign in page:
$lngstr['page_signin_box_signin_intro'] = '<font color="blue">Điền đúng "Username" và "Password"</font>';
$lngstr['page_signin_box_signin'] = $lngstr['label_username'];
$lngstr['page_signin_box_password'] = $lngstr['label_password'];
$lngstr['page_signin_box_register_intro'] = 'Liên hệ thầy Thạch để biết thêm về tài khoản đăng nhập !    </font>';
$lngstr['page_signin_box_lostpassword_intro'] = '<font color="red" size="25"></font>';
//$lngstr['page_signin_box_lostpassword_intro'] = '<b>em đã có tài khoản? </b> Nếu em <a href="lostpassword.php">quên Password</a>, Thầy sẽ gửi lại qua mail của em.<br><br>';
$lngstr['page_signin']['test_code'] = 'Mã bài kiểm tra:';

// Forgot password page:
$lngstr['page_lostpassword_enter_username'] = '<b>Hãy nhập username</b>';
...
$lngstr['inf_password_reset'] = 'Password đã được gửi lại, hãy mở mail ra xem nhé !.';
...
$lngstr['page_panel_hdr_test'] = 'Tên bài kiểm tra';
...
$lngstr['page-takeatest']['attempts_left'] = 'Được phép<br>(Số lần được phép làm bài : %d )';
...
$lngstr['page_takeatest']['score_total'] = 'Điểm tổng (của) em: %d / %d (%.2f%%)';
$lngstr['page_takeatest']['hdr_score'] = 'Điểm'; // 'Score'
$lngstr['page_takeatest']['hdr_score_hint'] = 'Điểm'; // 'Score (Bấm để sắp xếp)'
...
$lngstr['page_test']['finish_test'] = 'Hủy bài kiểm tra';
$lngstr['page_test']['qst_finish_test_header'] = 'Hủy không làm bài ';
$lngstr['page_test']['qst_finish_test'] = 'em có thực sự muốn hủy bài làm không ( nếu hủy thì bài kiểm tra này không có điểm ) ?';
...
$lngstr['page-testmanager']['attempts_allowed'] = 'Số lần kiểm tra cho phép:';
...
$lngstr['page_testmanager_stats']['hdr_points'] = 'Điểm';
$lngstr['page_testmanager_stats']['hdr_points_hint'] = 'Điểm';
...
$lngstr['page_editquestion_emptyquestion'] = '<p><strong></strong></p>';
...
$lngstr['page_reportsmanager']['view_pdf'] = 'Xem báo cáo em in PDF';
...
$lngstr['page_resourcemanager']['action_delete_resources'] = 'Delete resources ';
...
$lngstr['page_couponmanager']['action_delete_coupons'] = 'Delete coupons ';
...
$lngstr['email_answer_iscorrect'] = 'Correct(em làm đúng ko ?): ';
...
$lngstr['err_no_tests'] = 'Hiện không có bài kiểm tra cho thành viên này ...<br>';
...
$lngstr['inf_cant_view_results'] = 'em không có quyền thực hiện làm bài. Hãy đăng ký thành viên.<br>';
$lngstr['inf_cant_view_reportsmanager_reportsratings'] = 'You have not enough rights to view the ratings page.<br>';
$lngstr['inf_cant_view_this_test_details'] = 'em không có quyền xem kết quả.<br>';
...
$lngstr['err_no_answer_given'] = 'Một vài câu hỏi chưa trả lời, ...<br>';
$lngstr['err_answer_every_question'] = 'Có một số câu hỏi chưa trả lời, em hãy hoàn thành hết số câu hỏi trước khi gởi bài ...<br>';

$lngstr['err_no_permissions_to_register'] = 'em không có những sự cho phép để đăng ký một người sử dụng mới';

$lngstr['qst_delete_test'] = 'em chắc chắn muốn sẽ xóa sự thử này?';
$lngstr['qst_delete_tests'] = 'em chắc chắn muốn sẽ xóa những sự thử được lựa chọn?';
$lngstr['qst_delete_question'] = 'em chắc chắn muốn sẽ xóa câu hỏi này?';
$lngstr['qst_delete_questions'] = 'em chắc chắn muốn sẽ xóa những câu hỏi được lựa chọn?';
$lngstr['qst_delete_question_link'] = 'em chắc chắn muốn loại bỏ là câu hỏi này từ sự thử?';
$lngstr['qst_delete_question_links'] = 'em chắc chắn muốn loại bỏ lựa chọn là những câu hỏi từ sự thử?';
$lngstr['qst_delete_record'] = 'em chắc chắn muốn sẽ xóa bản ghi này?';
$lngstr['qst_delete_records'] = 'em chắc chắn muốn sẽ xóa những bản ghi được lựa chọn?';
$lngstr['qst_delete_user'] = 'em chắc chắn muốn sẽ xóa người sử dụng này?';
$lngstr['qst_delete_users'] = 'em chắc chắn muốn sẽ xóa những người sử dụng được lựa chọn?';
$lngstr['qst_delete_group'] = 'em chắc chắn muốn sẽ xóa nhóm này?';
$lngstr['qst_delete_groups'] = 'em chắc chắn muốn sẽ xóa những nhóm được lựa chọn?';
$lngstr['qst_delete_subject'] = 'em chắc chắn muốn sẽ xóa đề tài này?';
$lngstr['qst_delete_subjects'] = 'em chắc chắn muốn sẽ xóa những đề tài được lựa chọn?';
$lngstr['qst_delete_etemplate'] = 'em chắc chắn muốn sẽ xóa khung mẫu email này?';
$lngstr['qst_delete_etemplates'] = 'em chắc chắn muốn sẽ xóa những khung mẫu email được lựa chọn?';
$lngstr['qst_delete_grade'] = 'em chắc chắn muốn để xóa hệ thống đường dốc này?';
$lngstr['qst_delete_grades'] = 'em chắc chắn muốn sẽ xóa Hệ thống sấp xếp được lựa chọn?';
$lngstr['qst_delete_gradescale'] = 'em chắc chắn muốn sẽ xóa thứ bậc này?';
$lngstr['qst_delete_gradescales'] = 'em chắc chắn muốn sẽ xóa những thứ bậc được lựa chọn?';
$lngstr['qst_delete_visitor'] = $lngstr['qst_delete_record'];
$lngstr['qst_delete_visitors'] = $lngstr['qst_delete_records'];
$lngstr['page-sections']['qst_section_delete'] = 'em chắc chắn muốn sẽ xóa mục(khu vực) này?';
$lngstr['page-sections']['qst_sections_delete'] = 'em chắc chắn muốn sẽ xóa những mục(khu vực) được lựa chọn?';
$lngstr['page-rtemplates']['qst_rtemplate_delete'] = 'em chắc chắn muốn sẽ xóa khung mẫu báo cáo này?';
$lngstr['page-rtemplates']['qst_rtemplates_delete'] = 'em chắc chắn muốn sẽ xóa những khung mẫu báo cáo được lựa chọn?';

// Install:
$lngstr['install_title'] = 'Cài đặt - [BTX-MN_TrắcNghiệm]-[VTL_Test]';
...
<p><b>Địa chỉ trang trắc nghiệm BTX-MN(VD:/tracnghiem/)</b> Xin chỉ rõ địa chỉ web ở đâu . Mạng(lưới) được kiểm tra sẽ được truy nhập.
<p><b>Địa chỉ gốc [BTX-MN_TrắcNghiệm]-[VTL_Test] trên server:</b> Xin chỉ rõ đường dẫn thư mục đầy đủ tới sự cài đặt này.
<p><b>[BTX-MN_TrắcNghiệm]-[VTL_Test] files URL:</b> Xin chỉ rõ địa chỉ mạng ở đâu được nạp dữ liệu những hồ sơ sẽ được truy nhập.
<p><b>[BTX-MN_TrắcNghiệm]-[VTL_Test] files directory:</b> Xin chỉ rõ một đường dẫn thư mục đầy đủ ở đâu Bùi Thị Xuân. Mạng(lưới) được kiểm tra có thể cất giữ nạp dữ liệu những hồ sơ. Thư mục này cần phải (thì) đọc được và viết bởi người sử dụng người phục vụ mạng (usually "nobody" or "apache").';
$lngstr['install_titlepostfix'] = 'Tiêu đề Web:';
$lngstr['install_defaultemail'] = 'Email mặc định:';
$lngstr['install_urlroot'] = 'Địa chỉ trang trắc nghiệm BTX-MN(VD:/tracnghiem/):';
$lngstr['install_dirrootfull'] = 'Địa chỉ gốc trang trắc nghiệm [BTX-MN_TrắcNghiệm]-[VTL_Test] trên server:';
$lngstr['install_dirrootfull_doesnotexists'] = 'The "[BTX-MN_TrắcNghiệm]-[VTL_Test] directory" setting seems to be incorrect. Giá trị ở dưới đã được đặt lại.<br>';
$lngstr['install_urlfiles'] = 'Thư mục chứa file tải lên BTX-MN (VD:/tracnghiem/files/):';
$lngstr['install_dirfilesfull'] = 'Thư mục chứa file tải lên BTX-MN trên server:';
$lngstr['install_page3'] = 'Bước 3 - Thiết lập CSDL';
$lngstr['install_page3_description'] = '<p>Xin cấu hình hình cơ sở dữ liệu ở đâu BTX-MN. Mạng(lưới) được kiểm tra dữ liệu sẽ được cất giữ. Cơ sở dữ liệu này được phải đã có được tạo ra và một username và Password được tạo ra để truy nhập nó.';
...
$lngstr['install_dbpassword'] = 'Password CSDL:';
$lngstr['install_dbdriver_cannotconnect'] = 'Không thể nối tới cơ sở dữ liệu em chỉ rõ. Xin kiểm tra những sự thiết đặt cơ sở dữ liệu (của) các em.<br>';
...
$lngstr['install_db_title'] = 'Khởi tạo CSDL - [BTX-MN_TrắcNghiệm]-[VTL_Test]';
$lngstr['install_db_page1'] = 'Khởi tạo CSDL [BTX-MN_TrắcNghiệm]-[VTL_Test]';
...
$lngstr['initdb_etemplates_1_subject'] = '[BTX-MN_TrắcNghiệm]-[VTL_Test] - Báo cáo Mẫu';
$lngstr['initdb_etemplates_1_body'] = 'Chào [USER_FIRST_NAME],

ở đây những kết quả từ bài kiểm (của) các em:
...
Thân chào, chúc em học tốt và thành công trong tương lai !
Admin: Trần Thạch';
...
em có thể đăng nhập tới tài khoản (của) các em bất kỳ thời gian nào đến thăm:

[[BTX-MN_TrắcNghiệm]-[VTL_Test]_URL]
...
Tiếp theo em hãy làm như sau :

Để hoàn thành việc kích hoạt tài khoản (của) các em, xin kích vào mối liên kết sau đây

[[BTX-MN_TrắcNghiệm]-[VTL_Test]_URL]/account.php?action=activate&userid=[USER_ID]&checkword=[USER_CHECKWORD]
...
Tài khoản (của) Các em đã được kích hoạt một cách thành công .
...
$lngstr['initdb_etemplates_50_name'] = 'Khôi phục Password';
$lngstr['initdb_etemplates_50_description'] = 'Password recovery email template';
$lngstr['initdb_etemplates_50_subject'] = 'Khôi phục Password';
$lngstr['initdb_etemplates_50_body'] = 'Xin chào [USER_FIRST_NAME],

Thầy đã tạo Password mới cho em.
...
$lngstr['initdb_groups_19_name'] = 'Học sinh';
...
$lngstr['initdb_instructions'] = 'Xin sử dụng username "<strong>admin</strong>" và Password"<strong>admin</strong>" để đăng nhập.<br><strong>Vui lòng nhớ:</strong>  khuyến cáo thay đổi Password (của) các em sau khi đăng nhập.';
...
$lngstr['tooltip_tests'] = '';
$lngstr['tooltip_gscales'] = '';
$lngstr['tooltip_gscales_grades'] = '';
$lngstr['tooltip_etemplates'] = '';
$lngstr['tooltip_rtemplates'] = '';
...
$lngstr['tooltip_questionbank'] = '';
$lngstr['tooltip_subjects'] = '';
$lngstr['tooltip_reportsmanager'] = '';
$lngstr['tooltip_reportsmanager_reportsratings'] = '';
$lngstr['tooltip_users'] = '';
$lngstr['tooltip_users_groups'] = '';
$lngstr['tooltip_groups'] = '';
$lngstr['tooltip_visitors'] = '';
...
$lngstr['inf_no_records_found'] = 'Không tìm thấy bài kiểm tra nào.';
?>
...
$lngstr['language']['date_only_format'] = '%m/%d/%Y'; 
$lngstr['language']['date_format'] = '%m/%d/%y %I:%M %p'; 
$lngstr['language']['date_format_full'] = '%B %d, %Y %I:%M:%S %p'; 
...
$lngstr['page_takeatest']['hdr_score'] = 'Points'; 
$lngstr['page_takeatest']['hdr_score_hint'] = 'Points'; 
...
$lngstr['page_testmanager']['settings']['section_groups'] = 'Groups (click to show/hide)'; 
$lngstr['page_testmanager']['settings']['section_advanced'] = 'Advanced (click to show/hide)'; 
...
$lngstr['page_testmanager']['settings']['section_notes'] = 'Notes (click to show/hide)'; 

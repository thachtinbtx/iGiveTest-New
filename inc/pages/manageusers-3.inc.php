...
$bIsUserNameDuplicated = getRecordCount($srv_settings['table_prefix'].'users', 'user_name='.$g_db->qstr($arrValuesToUpdate['user_name']).(!$bIsNewUser ? ' AND userid<>'.$arrValuesToUpdate['userid'] : '')) > 0;
